...
## <img src="https://github.com/user-attachments/assets/4fe2c8f6-31fe-4f28-9d73-5758490ceb1c" alt="handshake" width="20"> <small>Note: In order to open links in external tabs, use <kbd>CTRL</kbd>+<small>click</small> (on Windows and Linux) or <kbd>CMD</kbd>+<small>click</small> (on macOS).</small>
