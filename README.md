...
<p style="font-size: 10px;"><large>Let's grow together!</large> Note: In order to open links in external tabs, use <kbd>CTRL</kbd>+<small>click</small> (on Windows and Linux) or <kbd>CMD</kbd>+<small>click</small> (on macOS).</p>
